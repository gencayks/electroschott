      ...
      <div
        className={cn(
          ...
          scrolled || !isHomePage
            ...
            : "bg-foreground/20 backdrop-blur-sm text-white",
        )}
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex items-center justify-between py-2 text-xs">
            <span className="opacity-90">Zertifizierter Entsorgungsfachbetrieb seit über 30 Jahren</span>
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3 lg:py-4 lg:px-8">
        <div className="flex lg:flex-1">
          <Link href="/" className="flex items-center gap-3 -m-1.5 p-1.5 group">
            <Image
              ...
              height={60}
              className={cn(
                "h-10 sm:h-12 lg:h-14 w-auto transition-all duration-300",
                scrolled || !isHomePage ? "logo-3d" : "brightness-0 invert drop-shadow-lg",
              )}
              priority
            />
          </Link>
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className={cn(
              "relative z-50 inline-flex items-center justify-center rounded-lg p-3 transition-colors touch-manipulation",
              scrolled
          ...
          <Button
            ...
            className={cn(
              scrolled || !isHomePage
                ...
                : "bg-white/15 hover:bg-white/25 text-white backdrop-blur-sm border border-white/20 shadow-lg",
            )}
          >
            <Link href="/kontakt">
              Anfrage stellen
              ...
              {navigation.map((item) => {
                ...
                return (
                  <li key={item.name}>
                    ...
                    >
                      {item.name}
                      <ChevronRight className={cn("w-5 h-5", isActive ? "text-primary" : "text-muted-foreground")} />
                    </Link>
                  </li>
                )
              })}
          ...
          <div className="px-4 py-6 border-t border-border space-y-4 bg-muted/30">
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-foreground">0621 – 86 23 97-0</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-foreground text-sm break-all">dispo@an-electrorecycling.de</p>
              </div>
            </a>
